...
function EditForm(props){
  ...
  useEffect(() => {
    EmployeeService.getEmployeeById(history.employeeNumber).then((resp)=>{
      let empData = resp.data;

      setFirstName(empData.firstName)
      setLastName(empData.lastName)
      setSalutation(empData.salutation)
      setProfileColour(empData.profileColour)
      setGender(empData.gender)
      setSalary(empData.salary)
      setEmployeeNumber(empData.employeeNumber)
      ...
      <Form>
        ...
        <Form.Group as={Row} className="mb-3" controlId="formGroupFullName">
          ...
          <Col>
            ...
            <Form.Control type="text" value={firstName} placeholder={firstName} onChange={e => setFirstName(e.currentTarget.value)}/>
          </Col>
        ...
        <Form.Group as={Row} className="mb-3"  xs={4} >
